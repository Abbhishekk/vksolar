...
$auth->requireAuth();
$auth->requirePermission('employee_management', 'create');
...
<head>
  ...
  <title>Add Employee - VK Solar</title>
  <style>
    .file-upload-area {
...
<body>
      ...
      <div class="container-fluid py-4">
          ...
          <div>
            ...
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="view_employees.php">Employees</a></li>
        ...
        <div class="card">
          <div class="card-header bg-success text-white">
            <h5 class="card-title mb-0"><i class="bi bi-person-plus me-2"></i>Add New Employee</h5>
          </div>
          <div class="card-body">
            <form id="employeeForm" method="POST" enctype="multipart/form-data">
              ...
              <div class="form-section">
                <h6 class="section-title"><i class="bi bi-shield-lock me-2"></i>System Access</h6>
                <div class="row g-3">
                  <div class="col-md-6">
                    <label for="username" class="form-label">Username *</label>
                    <input type="text" class="form-control" id="username" name="username" required>
                    <small class="text-muted">For system login</small>
                  </div>
                  <div class="col-md-6">
              ...
              <div class="text-center mt-4">
                ...
                <a href="add_employee"  class="btn btn-outline-secondary ml-2">
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      ...
      document.getElementById('employee_id').value = 'EMP' + Date.now().toString().slice(-6);
      ...
      form.addEventListener('submit', function(e) {
        ...
        .catch(error => {
          ...
          showMessage('error', 'An error occurred while adding employee');
        })
        .finally(() => {
