...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $serials_text = trim($_POST['serials'] ?? '');
    ...
    header("Location: ../inventory/warehouse_view.php?id=" . intval($warehouse_id));
    exit;
}
...
<main class="container py-4">
  <div class="d-flex justify-content-between align-items-center mb-3">
    <h3>Add Stock</h3>
    <a href="../inventory/warehouse_view.php?id=<?= intval($warehouse_id) ?>" class="btn btn-outline-secondary">Back</a>
  </div>
  ...
  <form method="post">
    ...
    <div class="row">
      ...
      <div class="col-md-8 mb-3">
        <label>Serials (optional, newline or comma separated)</label>
