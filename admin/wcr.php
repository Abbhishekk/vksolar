            ...
            <div class="professional-card">
                ...
                <div class="card-body">
                    <form id="reportForm">
                        ...
                        <div class="form-section">
                            <div class="section-title">
                                <i class="bi bi-sun"></i> Specification of the Modules
                            </div>
                            <div class="form-grid">
                                <div class="form-group">
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-grid">
                                <div class="form-group">
                                    <label for="inverter_make_model" class="required">Make & Model Number of Inverter</label>
                                    <input type="text" class="form-control" id="inverter_make_model" name="inverter_make_model" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="inverter_capacity" class="required">Capacity of Inverter</label>
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-grid">
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="earthings_count" name="earthings_count" required>
                                </div>
                                <div class="form-group">
                                    <label for="lightening_arrester" class="required">Lightening Arrester</label>
                                    <select class="form-control" id="lightening_arrester" name="lightening_arrester" required>
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-grid">
                                ...
                                <div class="form-group">
                                    <label for="aadhar_number" class="required">Aadhar Number</label>
            ...
            return `
                <div class="report-content">
                    ...
                    <div class="report-header">
                        <h2>Work Completion Report for Solar Power Plant</h2>
                        <p class="mb-0">Maharashtra State Electricity Distribution Co. Ltd. (MSEDCL)</p>
                    ...
                    <h4>Specification of the Modules</h4>
                    <table class="report-table">
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>${data.wattage_per_module} W</td>
                        </tr>
                        <tr>
                            <th>No. of Module</th>
                    ...
                    <h4>Earthing and Protections</h4>
                    <table class="report-table">
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>${data.lightening_arrester}</td>
                        </tr>
                    </table>

                    <div class="certification-box">
                        <p>It is certified that the Earth Resistance measure in presence of Licensed Electrical Contractor/Supervisor and found in order i.e. < 5 Ohms as per MNRE OM Dtd. 07.06.24 for CFA Component.</p>
                    </div>
                        ...
                        <div class="signature-area">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="signature-line" style="height: 80px;"></div>
                                </div>
                            </div>
                        </div>

                        <div class="certification-box mt-4">
                            ...
                            <p><em>SHOULD BE SELF ATTESTED BY CONSUMER</em></p>
                        </div>
                    </div>
