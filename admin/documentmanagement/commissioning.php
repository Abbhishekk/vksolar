...
?>
                    ...
                    <form id="commissioningForm">
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-grid">
                                ...
                                <div class="form-group">
                                    <label for="leter_no" class="required">Leter No.</label>
                                    <input type="text" class="form-control" id="leter_no" name="leter_no" value="" required>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-grid">
                                ...
                                <div class="form-group">
                                    <label for="company_email" class="required">Company_Email</label>
    ...
    fetch("save_commissioning", {
        method: "POST",
        body: formData
    }).catch(() => {
        console.warn("Save failed, preview will still continue");
    });
    ...
    window.scrollTo(0, 0);
        ...
        function createCommissioningReportHTML(data, formattedDate, totalCapacity) {
            return `
            <div style="">
                <div class="commissioning-header" style="margin: auto; padding: inherit;">
                    <h4>Renewable Energy Generating System</h4>
                    <h4>Annexure-l</h4>
                    <p><strong>(Commissioning Report for RE System)</strong></p>
                </div>

                <div class="commissioning-content">
                    <table class="commissioning-table" style="font-size:10px">
                        <tr>
                    ...
                    <div style="margin-top: 20px; font-size:9px">
                        <div style="text-align:center">
                            <div>
                                <h6>Proforma-A</h6>
                                <p style="text-align:center;">COMMISSIONING REPORT (PROVISIONAL) FOR GRID CONNECTED SOLAR <br> PHOTOVOLTAIC POWER PLANT (with Net-metering facility)</p>
                            </div>
                        <div>
                        ...
                        <div class="signature-area">
                            <div class="row">
                                <div class="col-sm-6">
                                    <div>
                                    <p><strong>Signature of the beneficiary</strong></p>
                                    <div>
                                        <img  src="https://vksolarenergy.com/${commissioningData.client_signature}" style="width: 50%; height : 50px; object-fit: contain;" >
                                    </div>
                                     </div>
                                    <p>Name: <strong> ${data.consumer_name}</strong> Consumer Number :-<strong>${data.consumer_number}</strong></p>
                                </div>
                                <div class="col-sm-6">
                                    <p><strong>Signature of the agency with name, seal</strong></p>
                                    <div>
                                     <img src="https://vksolarenergy.com/admin/documentmanagement/img/stamp.png" style="width: 50%; height : 50px; object-fit: contain;" >
                                     </div>
                                     <p>Name:<strong> Mr.Vilas Kale</strong></p>
                                </div>
                            </div>
                        </div>
                        <div>
                            <p> The above RTS installation has been inspected by me for Pre-Commissioning Testing of Roof Top Solar Connection on dt <strong>${data.installation_date}</strong> as per guidelines issued by the office of The Chief Engineer vide letter no  <strong>${data.leter_no}</strong> on dt. 18.08.2022 and found in order for commissioning</p>
                        </div>
                    </div>
