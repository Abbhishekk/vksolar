...
// admin/documentmanagement/undertaking/undertaking_list.php
...
<main class="container-fluid mt-4">
    ...
    <div class="doc-card">
        ...
        <div class="doc-card-header">
            <h4>Undertaking Documents</h4>
            <small>List of Undertaking Records</small>
        </div>
                        ...
                        <?php if ($result->num_rows > 0): ?>
                            <?php while ($row = $result->fetch_assoc()): ?>
                                <tr>
                                    ...
                                    <td><?= htmlspecialchars($row['system_capacity']) ?></td>
