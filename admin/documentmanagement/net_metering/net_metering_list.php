<?php
// admin/documentmanagement/net_metering/net_metering_list.php
...
$title = "Net Metering Agreements";

/* ---------- FETCH NET METERING DATA ---------- */
$sql = "
    SELECT 
        id,
        client_id,
...
<style>
/* ===== SAME UI AS COMMISSIONING / MODEL AGREEMENT LIST ===== */
...
<main class="container-fluid mt-4">
    ...
    <div class="doc-card">
        ...
        <div class="doc-card-header">
            <h4>Net Metering Agreements</h4>
            <small>View & edit generated agreements</small>
        </div>
                        ...
                        <?php if ($result && $result->num_rows > 0): ?>
                            <?php while ($row = $result->fetch_assoc()): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="index.php?client_id=<?= (int)$row['client_id'] ?>"
                        ...
                        <?php else: ?>
                            <tr>
                                <td colspan="6" class="text-muted text-center">
                                    No Net Metering Agreements Found
                                </td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
