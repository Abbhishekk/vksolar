      ...
      <div class="container-fluid py-4">
        ...
        <div class="card">
          <div class="card-header bg-success text-white">
            <h5 class="card-title mb-0"><i class="bi bi-person-plus me-2"></i>Add New User</h5>
          </div>
          <div class="card-body">
      ...
      form.addEventListener('submit', function(e) {
        ...
        .then(data => {
          if (data.success) {
            ...
            // Redirect to view users after 2 seconds
            setTimeout(() => {
        ...
        .catch(error => {
          ...
          showMessage('error', 'An error occurred while creating user');
        })
        .finally(() => {
