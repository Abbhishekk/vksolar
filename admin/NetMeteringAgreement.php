            ...
            return `
                <div class="pdf-optimized">
                    <div class="agreement-header">
                        <h2>Net Metering Connection Agreement</h2>
                    </div>
                    ...
                    <div class="agreement-content">
                        ...
                        <p>The Distribution Licensee- Maharashtra State Electricity Distribution Co. Ltd; and having its Registered Office at --- as second Party of this Agreement;</p>
                        ...
                        <div class="clause">
                            <div class="clause-title">1. Eligibility</div>
                        ...
                        <div class="clause">
                            <div class="clause-title">5. Period of Agreement, and Termination</div>
                        ...
                        <div class="clause">
                            <div class="clause-title">6. Access and Disconnection</div>
                        ...
                        <div class="clause">
                            <div class="clause-title">7. Liabilities</div>
                        ...
                        <div class="clause">
                            <div class="clause-title">8. Commercial Settlement</div>
                        ...
                        <div class="clause">
                            <div class="clause-title">9. Connection Costs</div>
                        ...
                        <div class="signature-area">
                            ...
                            <div style="display: flex; justify-content: space-between; margin-top: 30px;">
                                <div>
                                    <p>Witness 1 (VENDOR): <span class="highlight">${data.witness1_vendor}</span></p>
                                    <div class="signature-line"></div>
                                </div>
                                <div>
                                    <p>Witness 1 (MSEDCL): <span class="highlight">${data.witness1_msedcl}</span></p>
                                    <div class="signature-line"></div>
                                </div>
                            </div>
                        </div>
