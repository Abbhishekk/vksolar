 ...
 <div id="main-content">
                        ...
                        <form id="agreementForm">
                            ...
                            <div class="form-section">
                                ...
                                <div class="form-grid">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="applicant_address" name="applicant_address" rows="2" required></textarea>
                                    </div>
                                    <div class="form-group">
                            ...
                            <div class="form-section">
                                ...
                                <div class="form-grid">
                                    ...
                                    <div class="form-group">
                                        <label for="panel_make" class="required">Solar Panel Make & Model</label>
                                        <input type="text" class="form-control" id="panel_make" name="panel_make" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="panel_wattage" class="required">Panel Wattage</label>
                                        <input type="text" class="form-control" id="panel_wattage" name="panel_wattage" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="panel_efficiency" class="required">Panel Efficiency (%)</label>
                                        <input type="text" class="form-control" id="panel_efficiency" name="panel_efficiency" required>
                                    </div>
                                    <div class="form-group">
                            ...
                            <div class="form-section">
                                ...
                                <div class="form-grid">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="form-control" id="system_cost" name="system_cost" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="advance_percentage" class="required">Advance Payment (%)</label>
                                        <input type="number" class="form-control" id="advance_percentage" name="advance_percentage" value="10" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="dispatch_percentage" class="required">Payment Before Dispatch (%)</label>
                                        <input type="number" class="form-control" id="dispatch_percentage" name="dispatch_percentage" value="80" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="completion_percentage" class="required">Payment After Commissioning (%)</label>
                                        <input type="number" class="form-control" id="completion_percentage" name="completion_percentage" value="10" required>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        ...
        function generateAgreement() {
            ...
            // Validate form
            if (!data.applicant_name || !data.consumer_number || !data.applicant_address || 
                !data.agreement_date || !data.vendor_name || !data.vendor_address || 
                !data.system_capacity || !data.panel_make || !data.panel_wattage || 
                !data.panel_efficiency || !data.inverter_make || !data.inverter_capacity || 
                !data.system_cost) {
        ...
        function createAgreementHTML(data, formattedDate, advanceAmount, dispatchAmount, completionAmount) {
            return `
                <div class="agreement-header">
                    ...
                    <p class="mb-0">Between Applicant and the registered/empanelled Vendor</p>
                    <p>for installation of rooftop solar system in residential house of the Applicant</p>
                    <p>under simplified procedure of Rooftop Solar Programme Ph-II</p>
                </div>

                <div class="agreement-content">
                    <p>This agreement is executed on <span class="highlight">${formattedDate}</span> for design, Installation, commissioning and five years comprehensive maintenance of rooftop solar system to be installed under simplified procedure of Rooftop Solar Programme Ph-II.</p>
                    
                    <p><strong>Between</strong></p>
                    
                    <p><span class="highlight">${data.applicant_name}</span> residential electricity connection with consumer number <span class="highlight">${data.consumer_number}</span> from Maharashtra State Electricity Distribution Company Limited (MSEDCL) <span class="highlight">${data.applicant_address}</span> (hereinafter referred as Applicant).</p>
                    ...
                    <div class="agreement-footer">
                        <p>Generated on ${new Date().toLocaleDateString()} by Solar Installation Agreement Generator</p>
                    </div>
                </div>
            `;
        }
