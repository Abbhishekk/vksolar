...
$auth->requirePermission('bank_details_management', 'create');
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($bank_name && $branch_name && $account_number && $ifsc_code) {
        ...
        $stmt = $conn->prepare("
            ...
            (bank_name, branch_name, account_number, account_type, ifsc_code, bank_gst, is_active, created_by)
            VALUES (?, ?, ?, ?, ?, ?, ?, ?)
        ");
                ...
                <div class="col-md-8">
                    <div class="logo-container">
                        ...
                        <div class="header-content">
                            <h1>Bank Details</h1>
                            <p>Add New Bank to system . It will Fetch on Documents/Quotations</p>
                        </div>
                    </div>
                </div>
                    ...
                    <form method="POST">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="account_type" class="form-control" placeholder="Saving / Current">
                            </div>
                        </div>
                        ...
                        <div class="text-center">
                            <button type="submit" class="btn btn-success px-4">
                                <i class="bi bi-save"></i> Save Bank Details
                            </button>
