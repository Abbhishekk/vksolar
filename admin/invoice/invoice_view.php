<?php
// admin/invoice/invoice_view.php
...
<div class="invoice-box card shadow-sm">
<div class="card-body">
<div class="invoice">
...
<div class="d-flex gap-2 mt-4">
  <a href="invoices.php" class="btn btn-outline-secondary">Back</a>

  <?php if ($invoice['status'] === 'draft'): ?>
    <a href="invoice_finalize.php?id=<?= $invoice['id'] ?>" 
       class="btn btn-success"
       onclick="return confirm('Finalize invoice? This cannot be undone.')">
       Finalize Invoice
    </a>
  <?php endif; ?>

 <a target="__blank"
   href="print_invoice.php?id=<?= $id ?>&bank_id=<?= $bank_id ?>"
