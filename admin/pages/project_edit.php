...
$arr = null;
if (isset($_GET['id'])) {
    $res = $fun->singleProjectFetch($_GET['id']);
...
if (isset($_POST['submit']) && $arr) {
    $id = $_POST['id'];
    $projectName = $_POST['project_name'];
    $projectSummery = $_POST['project_summary'];

    $allowedTypes = ['jpg', 'jpeg', 'png', 'webp', 'svg'];

    // Background image
    if (!empty($_FILES['project_image']['name'])) {
        $imgName = basename($_FILES['project_image']['name']);
        ...
        if (in_array($img_type, $allowedTypes)) {
            $project_img = move_uploaded_file($tempName, $img_location);
            if (!$project_img) {
        ...
        $imgName = $arr['image_name'];
        $img_location = $arr['image_path'];
        $img_type = $arr['img_type'];
        $project_img = true;
    }
    

    // Update database if images are ok
    if ($project_img && empty($message)) {
        $updateResult = $fun->projectUpdate($id, $projectName, $projectSummery, $imgName, $img_location, $img_type);
        if ($updateResult) {
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input
                                                ...
                                                name="project_name"
                                                value="<?php echo $arr['project_name']; ?>"
                                                required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea
                                                ...
                                                required><?php echo $arr['project_summary']; ?></textarea>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="file-upload-area" id="uploadArea">
                                                ...
                                                <div class="image-preview" id="imagePreview">
                                                    ...
                                                    <img src="../../database/db_images/<?php echo $arr['image_name']; ?>" alt="Project Preview">
